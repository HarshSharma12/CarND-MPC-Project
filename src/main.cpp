      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // State after latency
          px += v*cos(psi)*LATENCY/1000;
          py += v*sin(psi)*LATENCY/1000;
          psi += -v*steer_value/Lf*LATENCY/1000;
          ...
          Eigen::Map<Eigen::VectorXd> waypoints_x_eig(&waypoints_x[0], ptsx.size());
          Eigen::Map<Eigen::VectorXd> waypoints_y_eig(&waypoints_y[0], ptsx.size());
